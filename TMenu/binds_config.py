...
binds_config.py
================
Load/save for BINDS' own binds.json (lives in data/, next to settings.json -
see app_paths.data_dir()). Same defensive style as settings.py: a missing,
...
BINDS_FILE = os.path.join(data_dir(), "binds.json")
